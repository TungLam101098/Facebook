    ...
    <div className="bg-[#e9ebee] h-screen">
      ...
      <div className="flex justify-center items-center ">
        <div className="w-4/5 sm:w-1/2 bg-white shadow-md relative mb-4 mt-4 p-7 pb-20 rounded-xl">
          <h4 className="text-xl font-bold pb-4">Nhập mã từ email của bạn</h4>
          <hr />
          ...
          <div className="relative">
            <span className="absolute left-4 top-6 text-gray-500">FB -</span>
            <input
          ...
          <hr />
          <button onClick={() => Continue()} className="mt-6 px-6 rounded-md py-3 border-none bg-blue-500 text-white absolute right-5 hover:bg-blue-600 ">
            Tiếp tục
          </button>
        </div>
      </div>
